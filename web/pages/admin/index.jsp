     ...
     <table class="table">
     				...
     				<tr>
     					...
     					<td align="right" style="padding-right:10px;font-size:10pt;font:bold;">
     							...
     							<a target="_content" href="#">密码管理</a>
     								|
     							<a  href="${pageContext.request.contextPath}/adminLogin?action=logout">安全退出</a>
     					</td>
     				</tr>
     			</table>
     		</td>
     	...
     	<tr id="content">
     		<td style="width:120px;vertical-align:top;padding:10px;">
     			...
     			<div class="menu" onmousemove="chg(this);" onmouseout="_chg(this);">
     					<a target="_content" href="${pageContext.request.contextPath }/admin/book?action=queryAllTypes" class="type">
     						图书上架
     					</a>
     			</div>
     			<div class="menu" onmousemove="chg(this);" onmouseout="_chg(this);">
